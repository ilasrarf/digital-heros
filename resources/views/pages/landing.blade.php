                ...
                <div class="container px-lg-5">
                    <div class="row align-items-end">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white text-center mb-4 animated slideInDown">نادي أبطال الديجيتال <br>
                                <p class="text-secondary" style="font-size: 30px; font-family: changa,Arial,sans-serif;"> علال الفاسي</p>
                            </h1>
                ...
                <article class="postcard dark blue">
                    ...
                    <div class="postcard__text">
                        <h2 class="postcard__title blue">
                            <p>صحح المفاهيم الخاطئة لي عندك حول مجال التعلم و العمل فالبرجمة...
                            </p>
                        </h2>
