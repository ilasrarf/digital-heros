        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="row m-2 justify-content-center">
                <div class="leftcolumn">
                    ...
                    <div class="card">
                        <img src="{{Voyager::image($post->image)}}" class="img">
                        <h2>{{$post->title}}</h2>
                        <h5>{{$post->excerpt}}</h5>
                ...
                <div class="rightcolumn">
                    ...
                    <div class="card">
                        ...
                        <ul class="cat-list p-0">
                            <li class="list-group-item @if(Request::routeIs('posts.show')) @if($category->id == $post->category->id) active @endif @endif">
                                <a href="#" class="d-flex justify-content-between @if(Request::routeIs('posts.show')) @if($category->id == $post->category->id) text-white @endif @endif">
                                    <p>{{ $category->name }}</p>
